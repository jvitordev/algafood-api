...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(
		...
		if (rootCause instanceof InvalidFormatException) {
            ...
            return handleTypeMismatch((MethodArgumentTypeMismatchException) rootCause, headers, status, request);
        }
        ...
        Problem problem = createProblemBuilder(status, problemType, detail, userMessage).build();
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers,
        ...
        String detail = String.format("O recurso '%s' que você tentou acessar, é inexistente.",
                ex.getRequestURL());
        String userMessage = "Página não encontrada! A página que você procurou não existe ou "
